...
public class MenuMenuItemDao implements MenuMenuItenDaoI{
    ...
    public List<MenuMenuItenTO> listaAccesos(String perfil, Properties idioma) {
        ...
        lista.add(new MenuMenuItenTO("Principal", "Usuario", "miusuario"));
        lista.add(new MenuMenuItenTO("Principal", "Proveedor", "miproveedor"));

        lista.add(new MenuMenuItenTO("Venta", "Reg. Venta", "miventa"));
        lista.add(new MenuMenuItenTO("Venta", "Reporte Ventas", "repventas"));
        lista.add(new MenuMenuItenTO("Venta", "Detalles Ventas", "detallesventas"));
